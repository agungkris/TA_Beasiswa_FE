  ...
  <div>
    ...
    <div class="login-form login-signin">
      <div class="text-center mb-10 mb-lg-10">
        ...
        <p class="text-muted font-weight-semi-bold">
          PERINGATAN!! Pendaftaran Beasiswa Pembangunan Jaya Anda akan gagal
...
export default {
  ...
  methods: {
    ...
    async validate() {
      if (
        ...
        await this.createUsers({ payload: this.usersData });
        await this.createProfiles({ payload: this.profilesData });
        this.usersData = {};
        this.profilesData = {};
    ...
    onSubmit() {
      ...
      this.createUsers({ payload: this.usersData }).then(() => {
        this.$router.push({ name: "login" });
      });
  ...
  computed: {
    ...
    ...mapState("profiles", ["profilesData"])
  }
};
</script>
